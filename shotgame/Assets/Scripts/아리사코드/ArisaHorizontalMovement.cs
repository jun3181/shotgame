...
public sealed class ArisaHorizontalMovement : MonoBehaviour
{
    ...
    [SerializeField] private float inertiaFrameRate = 12f;
    [SerializeField] private int inertiaFrameCount = 4;
    [SerializeField] private Animator animator;
    [SerializeField] private SpriteRenderer idleSpriteRenderer;
    [SerializeField] private SpriteRenderer bodySpriteRenderer;
    [SerializeField] private Sprite[] crouchSprites;
    [SerializeField] private float crouchFrameRate = 12f;
    [SerializeField] private SpriteRenderer inertiaSpriteRenderer;
    [SerializeField] private Animator inertiaAnimator;
    [SerializeField] private SpriteRenderer inertiaDustSpriteRenderer;
    [SerializeField] private Animator inertiaDustAnimator;
    [SerializeField] private SpriteRenderer[] inertiaOverlayRenderers;
    [SerializeField] private SpriteRenderer[] movingSpriteRenderers;
    [SerializeField] private BoxCollider2D movementCollider;
    [SerializeField] private ArisaStanceCollider stanceCollider;
    [SerializeField] private LayerMask horizontalCollisionLayers;
    [SerializeField] private LayerMask solidPlatformLayers;
    [SerializeField] private LayerMask oneWayPlatformLayers;
    [SerializeField] private bool collisionIncludesTriggers;
    [SerializeField] private float collisionSkinWidth = 0.02f;
    [SerializeField] private float groundedCheckDistance = 0.06f;
    [SerializeField] private float crouchGroundedCheckDistance = 0.3f;
    [SerializeField] private float crouchGroundedGraceTime = 0.08f;
    [SerializeField] private float oneWayPlatformTopTolerance = 0.05f;
